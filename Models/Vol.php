 ...
 // $stmt->close();
  $stmt=null;
   ...
   static public function update($data){
    $stmt=DB::connect()->prepare('UPDATE  vol SET LieuDepart =:LieuDepart ,LieuArrivé =:LieuArrivé,DateDepart =:DateDepart,DateArrive =:DateArrive,NbPlace =:NbPlace,Prix =:Prix,choix =:choix WHERE idVol=:idVol');
    $stmt->bindParam('idVol',$data['idVol']);
